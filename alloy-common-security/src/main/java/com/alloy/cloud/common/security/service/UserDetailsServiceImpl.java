...
//		UserDetails userDetails = getUserDetails(result);
		...
		UserDetails userDetails = new CloudUser(1, 1, "admin",
				SecurityConstants.BCRYPT + "admin",
				StrUtil.equals("flase", CommonConstants.STATUS_NORMAL), true, true, true, authorities);
